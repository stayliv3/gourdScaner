	...
	<div class="row">
		<div class="col-md-12">
			<nav class="navbar navbar-default" role="navigation">
				...
				$query=mysql_query("select count(*) as row from sqlmap where hash!='' and status='finished' and userhash='{$hash}'");
				$tcount='';
				while($row=mysql_fetch_array($query)){
					$tcount=$row['row'];
					...
					<button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1">
						...
						<li class="dropdown">
							...
							<ul class="dropdown-menu">
								...
								<li>
									<a class="navbar-brand" href="#">finished:<?php echo $tcount?></a>
								</li>
...
<!--						-->
<!--                   <center>-->
<!--                         <a href="/config.php#?action=startproxy" type='submit' disable="true" class="btn btn-default" value="Add....." >��������</a>-->
<!--                         <a href="/config.php#?action=stopproxy" type='submit'  class="btn btn-default" value="Add....." >�رմ���</a>-->
<!--                         <a href="/config.php#?action=startupdate" type='submit'  class="btn btn-default" value="Add....." >�ر��Զ�����</a>-->
<!--                         <a href="/config.php#?action=stopupdate" type='submit'  class="btn btn-default" value="Add....." >�����Զ�����</a>-->
<!--                         </center>-->
<!--                        </td>-->
<!--                -->
<!---->
...
<!--			</table>-->
    ...
    while($user=mysql_fetch_array($userhash)){
        ...
        $rows=mysql_query("select (select count(*) from sqlmap where userhash='{$user['userhash']}') as allcount,
                                  ...
                                  (select count(*) from sqlmap where userhash='{$user['userhash']}' and status='finished') as `finished`");
